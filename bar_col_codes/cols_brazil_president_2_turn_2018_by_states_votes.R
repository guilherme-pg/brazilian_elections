...
# ADJUST NAMES
greatest_states$NM_VOTAVEL[ greatest_states$NM_VOTAVEL == "JAIR MESSIAS BOLSONARO" ] <- "JAIR BOLSONARO"
...
colores <- c("Fernando Haddad"="firebrick1", 
                "Jair Bolsonaro"="dodgerblue4")

colores_bn <- c("Fernando Haddad"="firebrick1", 
                "Jair Messias Bolsonaro"="dodgerblue4",
             "Voto Nulo"="grey50",
             "Voto Branco"="grey75")
...
# save last plot
ggsave("f1_col_president_2_turn_2018_br_by_greatest_state_bn.jpg")
